...
namespace Tweetbook.Sdk
{
    ...
    partial class AutoGeneratedIIdentityApi : IIdentityApi
    {
        ...
        /// <inheritdoc />
        Task<ApiResponse<AuthSuccessResponse>> IIdentityApi.RefreshTokenAsync(RefreshTokenRequest refreshTokenRequest)
        {
            var arguments = new object[] { refreshTokenRequest };
            var func = requestBuilder.BuildRestResultFuncForMethod("RefreshTokenAsync", new Type[] { typeof(RefreshTokenRequest) });
            return (Task<ApiResponse<AuthSuccessResponse>>)func(Client, arguments);
        }
    }
}
...
namespace Tweetbook.Sdk
{
    ...
    partial class AutoGeneratedITweetbookApi : ITweetbookApi
    {
        ...
        /// <inheritdoc />
        Task<ApiResponse<List<PostResponse>>> ITweetbookApi.GetAsync(Guid postId)
        {
